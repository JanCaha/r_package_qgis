...
sagang_ihssharpening <- function(R = qgisprocess:::qgis_default_value(), G = qgisprocess:::qgis_default_value(), B = qgisprocess:::qgis_default_value(), PAN = qgisprocess:::qgis_default_value(), R_SHARP = qgisprocess:::qgis_default_value(), G_SHARP = qgisprocess:::qgis_default_value(), B_SHARP = qgisprocess:::qgis_default_value(), SHARPEN = qgisprocess:::qgis_default_value(), RESAMPLING = qgisprocess:::qgis_default_value(), PAN_MATCH = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("sagang:ihssharpening")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("sagang:ihssharpening", `R` = R, `G` = G, `B` = B, `PAN` = PAN, `R_SHARP` = R_SHARP, `G_SHARP` = G_SHARP, `B_SHARP` = B_SHARP, `SHARPEN` = SHARPEN, `RESAMPLING` = RESAMPLING, `PAN_MATCH` = PAN_MATCH,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("sagang:ihssharpening", `R` = R, `G` = G, `B` = B, `PAN` = PAN, `R_SHARP` = R_SHARP, `G_SHARP` = G_SHARP, `B_SHARP` = B_SHARP, `SHARPEN` = SHARPEN, `RESAMPLING` = RESAMPLING, `PAN_MATCH` = PAN_MATCH,..., .quiet = .quiet)
      )

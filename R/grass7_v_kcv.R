##' QGIS Algorithm provided by GRASS v.kcv (grass7:v.kcv)
##'
##' @title QGIS algorithm v.kcv
##'
##' @param map `source` - Input layer. Path to a vector layer.
##' @param npartitions `number` - Number of partitions. A numeric value.
##' @param column `string` - Name for new column to which partition number is written. String value.
...
grass7_v_kcv <- function(map = qgisprocess::qgis_default_value(), npartitions = qgisprocess::qgis_default_value(), column = qgisprocess::qgis_default_value(), output = qgisprocess::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess::qgis_default_value(), GRASS_SNAP_TOLERANCE_PARAMETER = qgisprocess::qgis_default_value(), GRASS_MIN_AREA_PARAMETER = qgisprocess::qgis_default_value(), GRASS_OUTPUT_TYPE_PARAMETER = qgisprocess::qgis_default_value(), GRASS_VECTOR_DSCO = qgisprocess::qgis_default_value(), GRASS_VECTOR_LCO = qgisprocess::qgis_default_value(), GRASS_VECTOR_EXPORT_NOCAT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {
  ...
  qgisprocess::assert_qgis_algorithm("grass7:v.kcv")

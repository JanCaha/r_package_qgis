##' QGIS Algorithm provided by GRASS v.kernel.vector (grass:v.kernel.vector). v.kernel.vector - Generates a vector density map from vector points on a vector network.
##'

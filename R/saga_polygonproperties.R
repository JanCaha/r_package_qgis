...
saga_polygonproperties <- function(POLYGONS = qgisprocess::qgis_default_value(), OUTPUT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("saga:polygonproperties")

  output <- qgisprocess::qgis_run_algorithm("saga:polygonproperties", `POLYGONS` = POLYGONS, `OUTPUT` = OUTPUT,...)

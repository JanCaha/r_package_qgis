##' QGIS Algorithm provided by GRASS v.edit (grass:v.edit). Edits a vector map, allows adding, deleting and modifying selected vector features.
##'
...
##' @param move `string` - Difference in x,y,z direction for moving feature or vertex. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param threshold `string` - Threshold distance (coords,snap,query). String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param ids `string` - Feature ids. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
...
##' @param coords `string` - List of point coordinates. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
...
##' @param polygon `string` - Polygon for selecting features. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
...
##' @param zbulk `string` - Starting value and step for z bulk-labeling. Pair: value,step (e.g. 1100,10). String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param .r `boolean` - Reverse selection. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -r.
##' @param .c `boolean` - Close added boundaries (using threshold distance). 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -c.
##' @param .n `boolean` - Do not expect header of input data. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -n.
...
##' @param .arg_1 `boolean` - Modify only first found feature in bounding box. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -1.
...
grass_v_edit <- function(map = qgisprocess:::qgis_default_value(), type = qgisprocess:::qgis_default_value(), tool = qgisprocess:::qgis_default_value(), input = qgisprocess:::qgis_default_value(), move = qgisprocess:::qgis_default_value(), threshold = qgisprocess:::qgis_default_value(), ids = qgisprocess:::qgis_default_value(), cats = qgisprocess:::qgis_default_value(), coords = qgisprocess:::qgis_default_value(), bbox = qgisprocess:::qgis_default_value(), polygon = qgisprocess:::qgis_default_value(), where = qgisprocess:::qgis_default_value(), query = qgisprocess:::qgis_default_value(), bgmap = qgisprocess:::qgis_default_value(), snap = qgisprocess:::qgis_default_value(), zbulk = qgisprocess:::qgis_default_value(), .r = qgisprocess:::qgis_default_value(), .c = qgisprocess:::qgis_default_value(), .n = qgisprocess:::qgis_default_value(), .b = qgisprocess:::qgis_default_value(), .arg_1 = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_SNAP_TOLERANCE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_MIN_AREA_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_OUTPUT_TYPE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_VECTOR_DSCO = qgisprocess:::qgis_default_value(), GRASS_VECTOR_LCO = qgisprocess:::qgis_default_value(), GRASS_VECTOR_EXPORT_NOCAT = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass:v.edit")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass:v.edit", `map` = map, `type` = type, `tool` = tool, `input` = input, `move` = move, `threshold` = threshold, `ids` = ids, `cats` = cats, `coords` = coords, `bbox` = bbox, `polygon` = polygon, `where` = where, `query` = query, `bgmap` = bgmap, `snap` = snap, `zbulk` = zbulk, `-r` = .r, `-c` = .c, `-n` = .n, `-b` = .b, `-1` = .arg_1, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_SNAP_TOLERANCE_PARAMETER` = GRASS_SNAP_TOLERANCE_PARAMETER, `GRASS_MIN_AREA_PARAMETER` = GRASS_MIN_AREA_PARAMETER, `GRASS_OUTPUT_TYPE_PARAMETER` = GRASS_OUTPUT_TYPE_PARAMETER, `GRASS_VECTOR_DSCO` = GRASS_VECTOR_DSCO, `GRASS_VECTOR_LCO` = GRASS_VECTOR_LCO, `GRASS_VECTOR_EXPORT_NOCAT` = GRASS_VECTOR_EXPORT_NOCAT,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass:v.edit", `map` = map, `type` = type, `tool` = tool, `input` = input, `move` = move, `threshold` = threshold, `ids` = ids, `cats` = cats, `coords` = coords, `bbox` = bbox, `polygon` = polygon, `where` = where, `query` = query, `bgmap` = bgmap, `snap` = snap, `zbulk` = zbulk, `-r` = .r, `-c` = .c, `-n` = .n, `-b` = .b, `-1` = .arg_1, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_SNAP_TOLERANCE_PARAMETER` = GRASS_SNAP_TOLERANCE_PARAMETER, `GRASS_MIN_AREA_PARAMETER` = GRASS_MIN_AREA_PARAMETER, `GRASS_OUTPUT_TYPE_PARAMETER` = GRASS_OUTPUT_TYPE_PARAMETER, `GRASS_VECTOR_DSCO` = GRASS_VECTOR_DSCO, `GRASS_VECTOR_LCO` = GRASS_VECTOR_LCO, `GRASS_VECTOR_EXPORT_NOCAT` = GRASS_VECTOR_EXPORT_NOCAT,..., .quiet = .quiet)
      )

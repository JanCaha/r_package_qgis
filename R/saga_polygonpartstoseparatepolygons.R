...
saga_polygonpartstoseparatepolygons <- function(POLYGONS = qgisprocess::qgis_default_value(), PARTS = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("saga:polygonpartstoseparatepolygons")

  output <- qgisprocess::qgis_run_algorithm("saga:polygonpartstoseparatepolygons", `POLYGONS` = POLYGONS, `PARTS` = PARTS,...)

##' QGIS Algorithm provided by GRASS v.net.allpairs (grass7:v.net.allpairs). Computes the shortest path between all pairs of nodes in the network
##'
##' @title QGIS algorithm - v.net.allpairs
##'
...
##' @param where `string` - WHERE condition of SQL statement without 'where' keyword'. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
...
##' @param output `vectorDestination` - Network_Allpairs. Path for new vector layer.
...
##' @details
##' ## Outputs description
##' * output - outputVector - Network_Allpairs
##'
##'
##' @export
##' @md

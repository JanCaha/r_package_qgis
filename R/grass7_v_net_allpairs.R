##' QGIS Algorithm provided by GRASS v.net.allpairs (grass7:v.net.allpairs)
##'
...
##' @param where `string` - WHERE condition of SQL statement without 'where' keyword'. String value.

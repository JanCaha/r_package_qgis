##' QGIS Algorithm provided by GRASS v.lidar.growing (grass:v.lidar.growing). Building contour determination and Region Growing algorithm for determining the building inside
##'

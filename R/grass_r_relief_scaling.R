##' QGIS Algorithm provided by GRASS r.relief.scaling (grass:r.relief.scaling). r.relief.scaling - Creates shaded relief from an elevation layer (DEM).
##'

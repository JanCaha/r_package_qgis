##' QGIS Algorithm provided by GRASS r.recode (grass:r.recode). Recodes categorical raster maps.
##'
##' @title QGIS algorithm - r.recode
##'
##' @param input `raster` - Input layer. Path to a raster layer.
##' @param rules `file` - File containing recode rules. Path to a file.
##' @param .d `boolean` - Force output to 'double' raster map type (DCELL). 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -d.
##' @param .a `boolean` - Align the current region to the input raster map. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -a.

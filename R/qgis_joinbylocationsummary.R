...
qgis_joinbylocationsummary <- function(INPUT = qgisprocess::qgis_default_value(), PREDICATE = qgisprocess::qgis_default_value(), JOIN = qgisprocess::qgis_default_value(), JOIN_FIELDS = qgisprocess::qgis_default_value(), SUMMARIES = qgisprocess::qgis_default_value(), DISCARD_NONMATCHING = qgisprocess::qgis_default_value(), OUTPUT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("qgis:joinbylocationsummary")

  output <- qgisprocess::qgis_run_algorithm("qgis:joinbylocationsummary", `INPUT` = INPUT, `PREDICATE` = PREDICATE, `JOIN` = JOIN, `JOIN_FIELDS` = JOIN_FIELDS, `SUMMARIES` = SUMMARIES, `DISCARD_NONMATCHING` = DISCARD_NONMATCHING, `OUTPUT` = OUTPUT,...)

...
##' @param .s `boolean` - Separate output for each angle (0, 45, 90, 135). 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.
##' @param .a `boolean` - Calculate all textural measurements. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.

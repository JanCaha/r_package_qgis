##' QGIS Algorithm provided by GRASS v.dissolve (grass7:v.dissolve). Dissolves boundaries between adjacent areas sharing a common category number or attribute.
##'
##' @title QGIS algorithm - v.dissolve
##'
##' @param input `source` - Input vector layer. Path to a vector layer.
##' @param column `field` - Name of column used to dissolve common boundaries. The name of an existing field. ; delimited list of existing field names.

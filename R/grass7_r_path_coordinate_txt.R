##' QGIS Algorithm provided by GRASS r.path.coordinate.txt (grass7:r.path.coordinate.txt). r.path.coordinate.txt - Traces paths from starting points following input directions.
##'

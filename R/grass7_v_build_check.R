##' QGIS Algorithm provided by GRASS v.build.check (grass7:v.build.check). v.build.check - Checks for topological errors.
##'
##' @title QGIS algorithm - v.build.check
##'
##' @param map `source` - Name of vector map. Path to a vector layer.
##' @param error `vectorDestination` - Topological errors. Path for new vector layer.
...
##' @details
##' ## Outputs description
##' * error - outputVector - Topological errors
##'
##'
##' @export
##' @md

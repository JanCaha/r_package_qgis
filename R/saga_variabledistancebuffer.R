...
saga_variabledistancebuffer <- function(SHAPES = qgisprocess::qgis_default_value(), DIST_FIELD = qgisprocess::qgis_default_value(), DIST_SCALE = qgisprocess::qgis_default_value(), NZONES = qgisprocess::qgis_default_value(), DARC = qgisprocess::qgis_default_value(), BUFFER = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("saga:variabledistancebuffer")

  output <- qgisprocess::qgis_run_algorithm("saga:variabledistancebuffer", `SHAPES` = SHAPES, `DIST_FIELD` = DIST_FIELD, `DIST_SCALE` = DIST_SCALE, `NZONES` = NZONES, `DARC` = DARC, `BUFFER` = BUFFER,...)

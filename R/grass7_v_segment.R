##' QGIS Algorithm provided by GRASS v.segment (grass7:v.segment). Creates points/segments from input vector lines and positions.
##'
##' @title QGIS algorithm - v.segment
##'
##' @param input `source` - Input lines layer. Path to a vector layer.
##' @param rules `file` - File containing segment rules. Path to a file.
##' @param output `vectorDestination` - Segments. Path for new vector layer.

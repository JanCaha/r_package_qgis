##' QGIS Algorithm provided by GRASS v.net.steiner (grass:v.net.steiner). Creates Steiner tree for the network and given terminals
##'
...
##' @param terminal_cats `string` - Category values. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param acolumn `field` - Arc forward\code{/}both direction(s) cost column (number). The name of an existing field. ; delimited list of existing field names.
##' @param npoints `number` - Number of Steiner points. A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.

...
qgis_downloadgpsdata <- function(DEVICE = qgisprocess::qgis_default_value(), PORT = qgisprocess::qgis_default_value(), FEATURE_TYPE = qgisprocess::qgis_default_value(), OUTPUT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("native:downloadgpsdata")

  output <- qgisprocess::qgis_run_algorithm("native:downloadgpsdata", `DEVICE` = DEVICE, `PORT` = PORT, `FEATURE_TYPE` = FEATURE_TYPE, `OUTPUT` = OUTPUT,...)

##' QGIS Algorithm provided by GRASS r.sunhours (grass:r.sunhours). Calculates solar elevation, solar azimuth, and sun hours.
##'
...
grass_r_sunhours <- function(year = qgisprocess:::qgis_default_value(), month = qgisprocess:::qgis_default_value(), day = qgisprocess:::qgis_default_value(), hour = qgisprocess:::qgis_default_value(), minute = qgisprocess:::qgis_default_value(), second = qgisprocess:::qgis_default_value(), .t = qgisprocess:::qgis_default_value(), .s = qgisprocess:::qgis_default_value(), elevation = qgisprocess:::qgis_default_value(), azimuth = qgisprocess:::qgis_default_value(), sunhour = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_OPT = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_META = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass:r.sunhours")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass:r.sunhours", `year` = year, `month` = month, `day` = day, `hour` = hour, `minute` = minute, `second` = second, `-t` = .t, `-s` = .s, `elevation` = elevation, `azimuth` = azimuth, `sunhour` = sunhour, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass:r.sunhours", `year` = year, `month` = month, `day` = day, `hour` = hour, `minute` = minute, `second` = second, `-t` = .t, `-s` = .s, `elevation` = elevation, `azimuth` = azimuth, `sunhour` = sunhour, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
      )

##' QGIS Algorithm provided by GRASS v.dissolve (grass:v.dissolve). Dissolves boundaries between adjacent areas sharing a common category number or attribute.
##'

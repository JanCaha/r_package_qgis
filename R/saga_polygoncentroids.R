...
saga_polygoncentroids <- function(POLYGONS = qgisprocess::qgis_default_value(), CENTROIDS = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("saga:polygoncentroids")

  output <- qgisprocess::qgis_run_algorithm("saga:polygoncentroids", `POLYGONS` = POLYGONS, `CENTROIDS` = CENTROIDS,...)

##' QGIS Algorithm provided by GRASS i.pansharpen (grass:i.pansharpen). Image fusion algorithms to sharpen multispectral with high-res panchromatic channels
##'
...
grass_i_pansharpen <- function(red = qgisprocess:::qgis_default_value(), green = qgisprocess:::qgis_default_value(), blue = qgisprocess:::qgis_default_value(), pan = qgisprocess:::qgis_default_value(), method = qgisprocess:::qgis_default_value(), .l = qgisprocess:::qgis_default_value(), .s = qgisprocess:::qgis_default_value(), redoutput = qgisprocess:::qgis_default_value(), greenoutput = qgisprocess:::qgis_default_value(), blueoutput = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_OPT = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_META = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass:i.pansharpen")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass:i.pansharpen", `red` = red, `green` = green, `blue` = blue, `pan` = pan, `method` = method, `-l` = .l, `-s` = .s, `redoutput` = redoutput, `greenoutput` = greenoutput, `blueoutput` = blueoutput, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass:i.pansharpen", `red` = red, `green` = green, `blue` = blue, `pan` = pan, `method` = method, `-l` = .l, `-s` = .s, `redoutput` = redoutput, `greenoutput` = greenoutput, `blueoutput` = blueoutput, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
      )

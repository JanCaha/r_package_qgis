...
qgis_extenttolayer <- function(INPUT = qgisprocess::qgis_default_value(), OUTPUT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_QGIS_versions()
  qgisprocess::assert_qgis()
  qgisprocess::assert_qgis_algorithm("native:extenttolayer")
  output <- qgisprocess::qgis_run_algorithm("native:extenttolayer",`INPUT` = INPUT, `OUTPUT` = OUTPUT,...)

##' QGIS Algorithm provided by GRASS v.in.geonames (grass7:v.in.geonames). Imports geonames.org country files into a GRASS vector points map.
##'
##' @title QGIS algorithm - v.in.geonames
##'
##' @param input `file` - Uncompressed geonames file from (with .txt extension). Path to a file.
##' @param output `vectorDestination` - Geonames. Path for new vector layer.

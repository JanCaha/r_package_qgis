##' QGIS Algorithm provided by GRASS v.delaunay (grass7:v.delaunay). Creates a Delaunay triangulation from an input vector map containing points or centroids.
##'
...
##' @param .l `boolean` - Output triangulation as a graph (lines), not areas. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -l.

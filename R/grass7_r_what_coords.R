##' QGIS Algorithm provided by GRASS r.what.coords (grass7:r.what.coords). r.what.coords - Queries raster maps on their category values and category labels on a point.
##'

##' QGIS Algorithm provided by GRASS v.what.vect (grass7:v.what.vect). Uploads vector values at positions of vector points to the table.
##'
...
grass7_v_what_vect <- function(map = qgisprocess:::qgis_default_value(), column = qgisprocess:::qgis_default_value(), query_map = qgisprocess:::qgis_default_value(), query_column = qgisprocess:::qgis_default_value(), dmax = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_SNAP_TOLERANCE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_MIN_AREA_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_OUTPUT_TYPE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_VECTOR_DSCO = qgisprocess:::qgis_default_value(), GRASS_VECTOR_LCO = qgisprocess:::qgis_default_value(), GRASS_VECTOR_EXPORT_NOCAT = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {
  ...
  check_algorithm_necessities("grass7:v.what.vect")

##' QGIS Algorithm provided by GRASS r.resamp.bspline (grass7:r.resamp.bspline). Performs bilinear or bicubic spline interpolation with Tykhonov regularization.
##'

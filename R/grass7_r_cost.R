##' QGIS Algorithm provided by GRASS r.cost (grass7:r.cost). Creates a raster layer of cumulative cost of moving across a raster layer whose cell values represent cost.
##'

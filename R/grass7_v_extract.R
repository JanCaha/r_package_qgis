##' QGIS Algorithm provided by GRASS v.extract (grass7:v.extract). Selects vector objects from a vector layer and creates a new layer containing only the selected objects.
##'

##' QGIS Algorithm provided by GRASS v.rast.stats (grass7:v.rast.stats). Calculates univariate statistics from a raster map based on vector polygons and uploads statistics to new attribute columns.
##'

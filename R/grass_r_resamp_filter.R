##' QGIS Algorithm provided by GRASS r.resamp.filter (grass:r.resamp.filter). Resamples raster map layers using an analytic kernel.
##'
...
##' @param radius `string` - Filter radius for each filter (comma separated list of float if multiple). String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param x_radius `string` - Filter radius (horizontal) for each filter (comma separated list of float if multiple). String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param y_radius `string` - Filter radius (vertical) for each filter (comma separated list of float if multiple). String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.

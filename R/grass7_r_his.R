##' QGIS Algorithm provided by GRASS r.his (grass7:r.his). Generates red, green and blue raster layers combining hue, intensity and saturation (HIS) values from user-specified input raster layers.
##'

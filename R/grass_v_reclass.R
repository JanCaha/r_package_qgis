##' QGIS Algorithm provided by GRASS v.reclass (grass:v.reclass). Changes vector category values for an existing vector map according to results of SQL queries or a value in attribute table column.
##'

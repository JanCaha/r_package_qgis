##' QGIS Algorithm provided by GRASS v.lidar.correction (grass7:v.lidar.correction). Correction of the v.lidar.growing output. It is the last of the three algorithms for LIDAR filtering.
##'

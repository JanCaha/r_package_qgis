##' QGIS Algorithm provided by GRASS v.rectify (grass7:v.rectify). Rectifies a vector by computing a coordinate transformation for each object in the vector based on the control points.
##'

##' QGIS Algorithm provided by GRASS r.drain (grass:r.drain). Traces a flow through an elevation model on a raster map.
##'
...
##' @param .d `boolean` - The input raster map is a cost surface (direction surface must also be specified). 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -d.

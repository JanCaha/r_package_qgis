##' QGIS Algorithm provided by GRASS v.what.vect (grass:v.what.vect). Uploads vector values at positions of vector points to the table.
##'
...
##' @param dmax `number` - Maximum query distance in map units. A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.

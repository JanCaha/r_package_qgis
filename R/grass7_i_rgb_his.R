##' QGIS Algorithm provided by GRASS i.rgb.his (grass7:i.rgb.his). Transforms raster maps from RGB (Red-Green-Blue) color space to HIS (Hue-Intensity-Saturation) color space.
##'

...
##' @param .r `boolean` - Print range only. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.
##' @param .g `boolean` - Print raster array information in shell script style. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.
##' @param .h `boolean` - Print raster history instead of info. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.
##' @param .e `boolean` - Print extended metadata information in shell script style. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.

##' QGIS Algorithm provided by GRASS r.out.ppm (grass7:r.out.ppm). Converts a raster layer to a PPM image file at the pixel resolution of the currently defined region.
##'

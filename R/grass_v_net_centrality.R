##' QGIS Algorithm provided by GRASS v.net.centrality (grass:v.net.centrality). Computes degree, centrality, betweenness, closeness and eigenvector centrality measures in the network.
##'

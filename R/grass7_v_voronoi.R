##' QGIS Algorithm provided by GRASS v.voronoi (grass7:v.voronoi). v.voronoi - Creates a Voronoi diagram from an input vector layer containing points.
##'

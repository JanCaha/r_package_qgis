...
qgis_collect <- function(INPUT = qgisprocess::qgis_default_value(), FIELD = qgisprocess::qgis_default_value(), OUTPUT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  qgisprocess::assert_qgis()
  qgisprocess::assert_qgis_algorithm("native:collect")
  output <- qgisprocess::qgis_run_algorithm("native:collect",`INPUT` = INPUT, `FIELD` = FIELD, `OUTPUT` = OUTPUT,...)

##' QGIS Algorithm provided by GRASS r.sim.water (grass:r.sim.water). Overland flow hydrologic simulation using path sampling method (SIMWE).
##'
...
##' @param rain `raster` - Name of the rainfall excess rate (rain-infilt) raster map (mm\code{/}hr). Path to a raster layer.
##' @param rain_value `number` - Rainfall excess rate unique value (mm\code{/}hr). A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param infil `raster` - Name of the runoff infiltration rate raster map (mm\code{/}hr). Path to a raster layer.
##' @param infil_value `number` - Runoff infiltration rate unique value (mm\code{/}hr). A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param man `raster` - Name of the Mannings n raster map. Path to a raster layer.
##' @param man_value `number` - Manning's n unique value. A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
...
##' @param nwalkers `number` - Number of walkers, default is twice the number of cells. A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
...
##' @param hmax `number` - Threshold water depth (m). A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param halpha `number` - Diffusion increase constant. A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param hbeta `number` - Weighting factor for water flow velocity vector. A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param .t `boolean` - Time-series output. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -t.
##' @param depth `rasterDestination` - Water depth (m). Path for new raster layer.
##' @param discharge `rasterDestination` - Water discharge (m3\code{/}s). Path for new raster layer.
...
##' * discharge - outputRaster - Water discharge (m3\code{/}s)
...
grass_r_sim_water <- function(elevation = qgisprocess:::qgis_default_value(), dx = qgisprocess:::qgis_default_value(), dy = qgisprocess:::qgis_default_value(), rain = qgisprocess:::qgis_default_value(), rain_value = qgisprocess:::qgis_default_value(), infil = qgisprocess:::qgis_default_value(), infil_value = qgisprocess:::qgis_default_value(), man = qgisprocess:::qgis_default_value(), man_value = qgisprocess:::qgis_default_value(), flow_control = qgisprocess:::qgis_default_value(), observation = qgisprocess:::qgis_default_value(), nwalkers = qgisprocess:::qgis_default_value(), niterations = qgisprocess:::qgis_default_value(), output_step = qgisprocess:::qgis_default_value(), diffusion_coeff = qgisprocess:::qgis_default_value(), hmax = qgisprocess:::qgis_default_value(), halpha = qgisprocess:::qgis_default_value(), hbeta = qgisprocess:::qgis_default_value(), .t = qgisprocess:::qgis_default_value(), depth = qgisprocess:::qgis_default_value(), discharge = qgisprocess:::qgis_default_value(), error = qgisprocess:::qgis_default_value(), walkers_output = qgisprocess:::qgis_default_value(), logfile = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_OPT = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_META = qgisprocess:::qgis_default_value(), GRASS_SNAP_TOLERANCE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_MIN_AREA_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_OUTPUT_TYPE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_VECTOR_DSCO = qgisprocess:::qgis_default_value(), GRASS_VECTOR_LCO = qgisprocess:::qgis_default_value(), GRASS_VECTOR_EXPORT_NOCAT = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {
  ...
  if (.complete_output) {
    ...
    qgisprocess::qgis_extract_output(output, "depth")
  }
}
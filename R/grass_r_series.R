##' QGIS Algorithm provided by GRASS r.series (grass:r.series). Makes each output cell value a function of the values assigned to the corresponding cells in the input raster layers. Input rasters layers/bands must be separated in different data sources.
##'
...
grass_r_series <- function(input = qgisprocess:::qgis_default_value(), .n = qgisprocess:::qgis_default_value(), method = qgisprocess:::qgis_default_value(), quantile = qgisprocess:::qgis_default_value(), weights = qgisprocess:::qgis_default_value(), range = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_OPT = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_META = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass:r.series")

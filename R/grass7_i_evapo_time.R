##' QGIS Algorithm provided by GRASS i.evapo.time (grass7:i.evapo.time). Computes temporal integration of satellite ET actual (ETa) following the daily ET reference (ETo) from meteorological station(s).
##'

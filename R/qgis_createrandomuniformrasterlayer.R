##' QGIS Algorithm provided by QGIS (native c++) Create random raster layer (uniform distribution) (native:createrandomuniformrasterlayer)
##'
...
##' @param LOWER_BOUND `number` - Lower bound for random number range. A numeric value.
##' @param UPPER_BOUND `number` - Upper bound for random number range. A numeric value.

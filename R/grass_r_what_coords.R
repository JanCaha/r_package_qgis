##' QGIS Algorithm provided by GRASS r.what.coords (grass:r.what.coords). r.what.coords - Queries raster maps on their category values and category labels on a point.
##'
...
##' @param separator `string` - Field separator. Special characters: pipe, comma, space, tab, newlineString representing NULL value. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
...
grass_r_what_coords <- function(map = qgisprocess:::qgis_default_value(), coordinates = qgisprocess:::qgis_default_value(), null_value = qgisprocess:::qgis_default_value(), separator = qgisprocess:::qgis_default_value(), cache = qgisprocess:::qgis_default_value(), .n = qgisprocess:::qgis_default_value(), .f = qgisprocess:::qgis_default_value(), .r = qgisprocess:::qgis_default_value(), .i = qgisprocess:::qgis_default_value(), .c = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass:r.what.coords")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass:r.what.coords", `map` = map, `coordinates` = coordinates, `null_value` = null_value, `separator` = separator, `cache` = cache, `-n` = .n, `-f` = .f, `-r` = .r, `-i` = .i, `-c` = .c, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass:r.what.coords", `map` = map, `coordinates` = coordinates, `null_value` = null_value, `separator` = separator, `cache` = cache, `-n` = .n, `-f` = .f, `-r` = .r, `-i` = .i, `-c` = .c, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER,..., .quiet = .quiet)
      )

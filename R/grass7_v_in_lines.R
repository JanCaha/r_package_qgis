##' QGIS Algorithm provided by GRASS v.in.lines (grass7:v.in.lines). Import ASCII x,y(,z) coordinates as a series of lines.
##'
##' @title QGIS algorithm - v.in.lines
##'

...
##' @param .d `boolean` - Force output to 'double' raster map type (DCELL). 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.
##' @param .a `boolean` - Align the current region to the input raster map. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.

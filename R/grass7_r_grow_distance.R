##' QGIS Algorithm provided by GRASS r.grow.distance (grass7:r.grow.distance). Generates a raster layer of distance to features in input layer.
##'
...
grass7_r_grow_distance <- function(input = qgisprocess:::qgis_default_value(), metric = qgisprocess:::qgis_default_value(), .m = qgisprocess:::qgis_default_value(), .n = qgisprocess:::qgis_default_value(), distance = qgisprocess:::qgis_default_value(), value = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_OPT = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_META = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass7:r.grow.distance")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass7:r.grow.distance", `input` = input, `metric` = metric, `-m` = .m, `-n` = .n, `distance` = distance, `value` = value, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass7:r.grow.distance", `input` = input, `metric` = metric, `-m` = .m, `-n` = .n, `distance` = distance, `value` = value, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
      )

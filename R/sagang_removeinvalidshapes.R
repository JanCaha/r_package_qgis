##' QGIS Algorithm provided by SAGA Next Gen Remove invalid shapes (sagang:removeinvalidshapes). ---------------- Arguments ----------------  SHAPES: Shapes 	Argument type:	source 	Acceptable values: 		- Path to a vector layer
##'
##' @title QGIS algorithm - Remove invalid shapes
##'

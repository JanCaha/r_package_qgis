##' QGIS Algorithm provided by GRASS r.profile (grass7:r.profile). Outputs the raster layer values lying on user-defined line(s).
##'
...
grass7_r_profile <- function(input = qgisprocess:::qgis_default_value(), coordinates = qgisprocess:::qgis_default_value(), resolution = qgisprocess:::qgis_default_value(), null_value = qgisprocess:::qgis_default_value(), file = qgisprocess:::qgis_default_value(), .g = qgisprocess:::qgis_default_value(), .c = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {
  ...
  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass7:r.profile", `input` = input, `coordinates` = coordinates, `resolution` = resolution, `null_value` = null_value, `file` = file, `-g` = .g, `-c` = .c, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass7:r.profile", `input` = input, `coordinates` = coordinates, `resolution` = resolution, `null_value` = null_value, `file` = file, `-g` = .g, `-c` = .c, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER,..., .quiet = .quiet)
      )

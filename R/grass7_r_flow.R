##' QGIS Algorithm provided by GRASS r.flow (grass7:r.flow). Construction of flowlines, flowpath lengths, and flowaccumulation (contributing areas) from a raster digital elevation model (DEM).
##'

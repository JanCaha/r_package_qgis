##' QGIS Algorithm provided by GRASS r.li.patchdensity.ascii (grass7:r.li.patchdensity.ascii). r.li.patchdensity.ascii - Calculates patch density index on a raster map, using a 4 neighbour algorithm
##'

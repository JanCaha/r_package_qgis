##' QGIS Algorithm provided by SAGA Gwr for single predictor (gridded model output) (saga:gwrforsinglepredictorgriddedmodeloutput)
##'
##' @title QGIS algorithm Gwr for single predictor (gridded model output)
##'
##' @param POINTS `source` - Points. Path to a vector layer.
##' @param DEPENDENT `field` - Dependent Variable. The name of an existing field. ; delimited list of existing field names.
##' @param PREDICTOR `field` - Predictor. The name of an existing field. ; delimited list of existing field names.
...
saga_gwrforsinglepredictorgriddedmodeloutput <- function(POINTS = qgisprocess::qgis_default_value(), DEPENDENT = qgisprocess::qgis_default_value(), PREDICTOR = qgisprocess::qgis_default_value(), TARGET_DEFINITION = qgisprocess::qgis_default_value(), TARGET_USER_SIZE = qgisprocess::qgis_default_value(), TARGET_USER_XMIN = qgisprocess::qgis_default_value(), TARGET_USER_XMAX = qgisprocess::qgis_default_value(), TARGET_USER_YMIN = qgisprocess::qgis_default_value(), TARGET_USER_YMAX = qgisprocess::qgis_default_value(), TARGET_USER_FITS = qgisprocess::qgis_default_value(), TARGET_TEMPLATE = qgisprocess::qgis_default_value(), TARGET_OUT_GRID = qgisprocess::qgis_default_value(), INTERCEPT = qgisprocess::qgis_default_value(), SLOPE = qgisprocess::qgis_default_value(), QUALITY = qgisprocess::qgis_default_value(), DW_WEIGHTING = qgisprocess::qgis_default_value(), DW_IDW_POWER = qgisprocess::qgis_default_value(), DW_IDW_OFFSET = qgisprocess::qgis_default_value(), DW_BANDWIDTH = qgisprocess::qgis_default_value(), SEARCH_RANGE = qgisprocess::qgis_default_value(), SEARCH_RADIUS = qgisprocess::qgis_default_value(), SEARCH_POINTS_ALL = qgisprocess::qgis_default_value(), SEARCH_POINTS_MIN = qgisprocess::qgis_default_value(), SEARCH_POINTS_MAX = qgisprocess::qgis_default_value(), SEARCH_DIRECTION = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {
  ...
  qgisprocess::assert_qgis_algorithm("saga:gwrforsinglepredictorgriddedmodeloutput")
  output <- qgisprocess::qgis_run_algorithm("saga:gwrforsinglepredictorgriddedmodeloutput",`POINTS` = POINTS, `DEPENDENT` = DEPENDENT, `PREDICTOR` = PREDICTOR, `TARGET_DEFINITION` = TARGET_DEFINITION, `TARGET_USER_SIZE` = TARGET_USER_SIZE, `TARGET_USER_XMIN` = TARGET_USER_XMIN, `TARGET_USER_XMAX` = TARGET_USER_XMAX, `TARGET_USER_YMIN` = TARGET_USER_YMIN, `TARGET_USER_YMAX` = TARGET_USER_YMAX, `TARGET_USER_FITS` = TARGET_USER_FITS, `TARGET_TEMPLATE` = TARGET_TEMPLATE, `TARGET_OUT_GRID` = TARGET_OUT_GRID, `INTERCEPT` = INTERCEPT, `SLOPE` = SLOPE, `QUALITY` = QUALITY, `DW_WEIGHTING` = DW_WEIGHTING, `DW_IDW_POWER` = DW_IDW_POWER, `DW_IDW_OFFSET` = DW_IDW_OFFSET, `DW_BANDWIDTH` = DW_BANDWIDTH, `SEARCH_RANGE` = SEARCH_RANGE, `SEARCH_RADIUS` = SEARCH_RADIUS, `SEARCH_POINTS_ALL` = SEARCH_POINTS_ALL, `SEARCH_POINTS_MIN` = SEARCH_POINTS_MIN, `SEARCH_POINTS_MAX` = SEARCH_POINTS_MAX, `SEARCH_DIRECTION` = SEARCH_DIRECTION,...)

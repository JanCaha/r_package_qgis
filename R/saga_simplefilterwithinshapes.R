...
saga_simplefilterwithinshapes <- function(INPUT = qgisprocess:::qgis_default_value(), RESULT = qgisprocess:::qgis_default_value(), SHAPES = qgisprocess:::qgis_default_value(), MODE = qgisprocess:::qgis_default_value(), METHOD = qgisprocess:::qgis_default_value(), RADIUS = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("saga:simplefilterwithinshapes")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("saga:simplefilterwithinshapes", `INPUT` = INPUT, `RESULT` = RESULT, `SHAPES` = SHAPES, `MODE` = MODE, `METHOD` = METHOD, `RADIUS` = RADIUS,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("saga:simplefilterwithinshapes", `INPUT` = INPUT, `RESULT` = RESULT, `SHAPES` = SHAPES, `MODE` = MODE, `METHOD` = METHOD, `RADIUS` = RADIUS,..., .quiet = .quiet)
      )

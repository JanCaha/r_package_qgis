##' QGIS Algorithm provided by QGIS (native c++) Create random raster layer (binomial distribution) (native:createrandombinomialrasterlayer)
##'
...
##' @param N `number` - N. A numeric value.

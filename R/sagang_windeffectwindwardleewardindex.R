...
sagang_windeffectwindwardleewardindex <- function(DEM = qgisprocess:::qgis_default_value(), DIR = qgisprocess:::qgis_default_value(), DIR_UNITS = qgisprocess:::qgis_default_value(), LEN = qgisprocess:::qgis_default_value(), LEN_SCALE = qgisprocess:::qgis_default_value(), EFFECT = qgisprocess:::qgis_default_value(), AFH = qgisprocess:::qgis_default_value(), MAXDIST = qgisprocess:::qgis_default_value(), DIR_CONST = qgisprocess:::qgis_default_value(), OLDVER = qgisprocess:::qgis_default_value(), ACCEL = qgisprocess:::qgis_default_value(), PYRAMIDS = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("sagang:windeffectwindwardleewardindex")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("sagang:windeffectwindwardleewardindex", `DEM` = DEM, `DIR` = DIR, `DIR_UNITS` = DIR_UNITS, `LEN` = LEN, `LEN_SCALE` = LEN_SCALE, `EFFECT` = EFFECT, `AFH` = AFH, `MAXDIST` = MAXDIST, `DIR_CONST` = DIR_CONST, `OLDVER` = OLDVER, `ACCEL` = ACCEL, `PYRAMIDS` = PYRAMIDS,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("sagang:windeffectwindwardleewardindex", `DEM` = DEM, `DIR` = DIR, `DIR_UNITS` = DIR_UNITS, `LEN` = LEN, `LEN_SCALE` = LEN_SCALE, `EFFECT` = EFFECT, `AFH` = AFH, `MAXDIST` = MAXDIST, `DIR_CONST` = DIR_CONST, `OLDVER` = OLDVER, `ACCEL` = ACCEL, `PYRAMIDS` = PYRAMIDS,..., .quiet = .quiet)
      )

##' QGIS Algorithm provided by GRASS v.qcount (grass7:v.qcount)
##'
##' @title QGIS algorithm v.qcount
##'
##' @param input `source` - Vector points layer. Path to a vector layer.
##' @param nquadrats `number` - Number of quadrats. A numeric value.
##' @param radius `number` - Quadrat radius. A numeric value.
...
grass7_v_qcount <- function(input = qgisprocess::qgis_default_value(), nquadrats = qgisprocess::qgis_default_value(), radius = qgisprocess::qgis_default_value(), output = qgisprocess::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess::qgis_default_value(), GRASS_SNAP_TOLERANCE_PARAMETER = qgisprocess::qgis_default_value(), GRASS_MIN_AREA_PARAMETER = qgisprocess::qgis_default_value(), GRASS_OUTPUT_TYPE_PARAMETER = qgisprocess::qgis_default_value(), GRASS_VECTOR_DSCO = qgisprocess::qgis_default_value(), GRASS_VECTOR_LCO = qgisprocess::qgis_default_value(), GRASS_VECTOR_EXPORT_NOCAT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {
  ...
  qgisprocess::assert_qgis_algorithm("grass7:v.qcount")

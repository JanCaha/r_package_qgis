##' QGIS Algorithm provided by GRASS v.hull (grass7:v.hull). Produces a convex hull for a given vector map.
##'
##' @title QGIS algorithm - v.hull
##'
...
##' @param .f `boolean` - Create a 'flat' 2D hull even if the input is 3D points. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -f.
...
##' @details
##' ## Outputs description
##' * output - outputVector - Convex hull
##'
##'
##' @export
##' @md

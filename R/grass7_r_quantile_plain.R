##' QGIS Algorithm provided by GRASS r.quantile.plain (grass7:r.quantile.plain). r.quantile.plain - Compute quantiles using two passes and save them as plain text.
##'

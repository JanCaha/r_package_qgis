...
saga_simplefilter <- function(INPUT = qgisprocess:::qgis_default_value(), MODE = qgisprocess:::qgis_default_value(), METHOD = qgisprocess:::qgis_default_value(), RADIUS = qgisprocess:::qgis_default_value(), RESULT = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("saga:simplefilter")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("saga:simplefilter", `INPUT` = INPUT, `MODE` = MODE, `METHOD` = METHOD, `RADIUS` = RADIUS, `RESULT` = RESULT,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("saga:simplefilter", `INPUT` = INPUT, `MODE` = MODE, `METHOD` = METHOD, `RADIUS` = RADIUS, `RESULT` = RESULT,..., .quiet = .quiet)
      )

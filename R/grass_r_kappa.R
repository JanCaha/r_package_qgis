##' QGIS Algorithm provided by GRASS r.kappa (grass:r.kappa). Calculate error matrix and kappa parameter for accuracy assessment of classification result.
##'

...
##' @param parameters `string` - Parameter(s) of distribution (uniform: maximum; normal: mean and stddev). String value.
##' @param minimum `number` - Minimum deviation in map units. A numeric value.

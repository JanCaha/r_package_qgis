##' QGIS Algorithm provided by GRASS i.rgb.his (grass:i.rgb.his). Transforms raster maps from RGB (Red-Green-Blue) color space to HIS (Hue-Intensity-Saturation) color space.
##'

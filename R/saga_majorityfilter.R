...
saga_majorityfilter <- function(INPUT = qgisprocess::qgis_default_value(), MODE = qgisprocess::qgis_default_value(), RADIUS = qgisprocess::qgis_default_value(), THRESHOLD = qgisprocess::qgis_default_value(), RESULT = qgisprocess::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("saga:majorityfilter")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("saga:majorityfilter", `INPUT` = INPUT, `MODE` = MODE, `RADIUS` = RADIUS, `THRESHOLD` = THRESHOLD, `RESULT` = RESULT,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("saga:majorityfilter", `INPUT` = INPUT, `MODE` = MODE, `RADIUS` = RADIUS, `THRESHOLD` = THRESHOLD, `RESULT` = RESULT,..., .quiet = .quiet)
      )

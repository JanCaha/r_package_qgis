##' QGIS Algorithm provided by GRASS v.net.visibility (grass:v.net.visibility). Performs visibility graph construction.
##'
##' @title QGIS algorithm - v.net.visibility
##'
##' @param input `source` - Input vector line layer (arcs). Path to a vector layer.
##' @param coordinates `string` - Coordinates. String value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.

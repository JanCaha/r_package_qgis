...
##' @param .r `boolean` - Reverse transformation; 3D vector features to 2D. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.
##' @param .t `boolean` - Do not copy attribute table. 1 for true/yes. 0 for false/no. Original algorithm parameter name: {name}.

##' QGIS Algorithm provided by GRASS v.net.components (grass:v.net.components). Computes strongly and weakly connected components in the network.
##'

...
saga_clusteranalysis <- function(INPUT = qgisprocess:::qgis_default_value(), RESULT = qgisprocess:::qgis_default_value(), STATISTICS = qgisprocess:::qgis_default_value(), FIELDS = qgisprocess:::qgis_default_value(), CLUSTER = qgisprocess:::qgis_default_value(), METHOD = qgisprocess:::qgis_default_value(), NCLUSTER = qgisprocess:::qgis_default_value(), NORMALISE = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("saga:clusteranalysis")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("saga:clusteranalysis", `INPUT` = INPUT, `RESULT` = RESULT, `STATISTICS` = STATISTICS, `FIELDS` = FIELDS, `CLUSTER` = CLUSTER, `METHOD` = METHOD, `NCLUSTER` = NCLUSTER, `NORMALISE` = NORMALISE,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("saga:clusteranalysis", `INPUT` = INPUT, `RESULT` = RESULT, `STATISTICS` = STATISTICS, `FIELDS` = FIELDS, `CLUSTER` = CLUSTER, `METHOD` = METHOD, `NCLUSTER` = NCLUSTER, `NORMALISE` = NORMALISE,..., .quiet = .quiet)
      )

##' QGIS Algorithm provided by GRASS v.net.spanningtree (grass7:v.net.spanningtree)
##'
##' @title QGIS algorithm v.net.spanningtree
##'
##' @param input `source` - Input vector line layer (arcs). Path to a vector layer.
##' @param points `source` - Input point layer (nodes). Path to a vector layer.
...
##' @param output `vectorDestination` - SpanningTree. Path for new vector layer.

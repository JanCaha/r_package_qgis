##' QGIS Algorithm provided by QGIS (native c++) Generate points (pixel centroids) inside polygons (native:generatepointspixelcentroidsinsidepolygons). Generates pixel centroids for the raster area falling inside polygons. This algorithm generates pixel centroids for the raster area falling inside polygons. Used to generate points for further raster sampling.  ---------------- Notes ----------------   - This algorithm drops existing primary keys or FID values and regenerates them in output layers.
##'

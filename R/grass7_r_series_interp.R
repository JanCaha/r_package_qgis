##' QGIS Algorithm provided by GRASS r.series.interp (grass7:r.series.interp). Interpolates raster maps located (temporal or spatial) in between input raster maps at specific sampling positions.
##'
...
grass7_r_series_interp <- function(input = qgisprocess:::qgis_default_value(), datapos = qgisprocess:::qgis_default_value(), infile = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), samplingpos = qgisprocess:::qgis_default_value(), outfile = qgisprocess:::qgis_default_value(), method = qgisprocess:::qgis_default_value(), output_dir = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

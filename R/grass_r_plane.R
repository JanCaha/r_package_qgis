##' QGIS Algorithm provided by GRASS r.plane (grass:r.plane). Creates raster plane layer given dip (inclination), aspect (azimuth) and one point.
##'
...
grass_r_plane <- function(dip = qgisprocess:::qgis_default_value(), azimuth = qgisprocess:::qgis_default_value(), easting = qgisprocess:::qgis_default_value(), northing = qgisprocess:::qgis_default_value(), elevation = qgisprocess:::qgis_default_value(), type = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_OPT = qgisprocess:::qgis_default_value(), GRASS_RASTER_FORMAT_META = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass:r.plane")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass:r.plane", `dip` = dip, `azimuth` = azimuth, `easting` = easting, `northing` = northing, `elevation` = elevation, `type` = type, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass:r.plane", `dip` = dip, `azimuth` = azimuth, `easting` = easting, `northing` = northing, `elevation` = elevation, `type` = type, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER, `GRASS_RASTER_FORMAT_OPT` = GRASS_RASTER_FORMAT_OPT, `GRASS_RASTER_FORMAT_META` = GRASS_RASTER_FORMAT_META,..., .quiet = .quiet)
      )

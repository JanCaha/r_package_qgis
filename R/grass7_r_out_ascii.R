##' QGIS Algorithm provided by GRASS r.out.ascii (grass7:r.out.ascii). Export a raster layer into a GRASS ASCII text file
##'
...
grass7_r_out_ascii <- function(input = qgisprocess:::qgis_default_value(), precision = qgisprocess:::qgis_default_value(), width = qgisprocess:::qgis_default_value(), null_value = qgisprocess:::qgis_default_value(), .s = qgisprocess:::qgis_default_value(), .m = qgisprocess:::qgis_default_value(), .i = qgisprocess:::qgis_default_value(), output = qgisprocess:::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess:::qgis_default_value(), GRASS_REGION_CELLSIZE_PARAMETER = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("grass7:r.out.ascii")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("grass7:r.out.ascii", `input` = input, `precision` = precision, `width` = width, `null_value` = null_value, `-s` = .s, `-m` = .m, `-i` = .i, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("grass7:r.out.ascii", `input` = input, `precision` = precision, `width` = width, `null_value` = null_value, `-s` = .s, `-m` = .m, `-i` = .i, `output` = output, `GRASS_REGION_PARAMETER` = GRASS_REGION_PARAMETER, `GRASS_REGION_CELLSIZE_PARAMETER` = GRASS_REGION_CELLSIZE_PARAMETER,..., .quiet = .quiet)
      )

...
##' @param .s `boolean` - Write output as original input segments, not each path as one line. 1 for true/yes. 0 for false/no. Original algorithm parameter name: -s.
...
grass7_v_net_path <- function(input = qgisprocess::qgis_default_value(), points = qgisprocess::qgis_default_value(), file = qgisprocess::qgis_default_value(), threshold = qgisprocess::qgis_default_value(), arc_type = qgisprocess::qgis_default_value(), arc_column = qgisprocess::qgis_default_value(), arc_backward_column = qgisprocess::qgis_default_value(), node_column = qgisprocess::qgis_default_value(), dmax = qgisprocess::qgis_default_value(), .g = qgisprocess::qgis_default_value(), .s = qgisprocess::qgis_default_value(), output = qgisprocess::qgis_default_value(), GRASS_REGION_PARAMETER = qgisprocess::qgis_default_value(), GRASS_SNAP_TOLERANCE_PARAMETER = qgisprocess::qgis_default_value(), GRASS_MIN_AREA_PARAMETER = qgisprocess::qgis_default_value(), GRASS_OUTPUT_TYPE_PARAMETER = qgisprocess::qgis_default_value(), GRASS_VECTOR_DSCO = qgisprocess::qgis_default_value(), GRASS_VECTOR_LCO = qgisprocess::qgis_default_value(), GRASS_VECTOR_EXPORT_NOCAT = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {
  ...
  qgisprocess::assert_qgis_algorithm("grass7:v.net.path")

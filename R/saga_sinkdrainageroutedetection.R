...
saga_sinkdrainageroutedetection <- function(ELEVATION = qgisprocess::qgis_default_value(), THRSHEIGHT = qgisprocess::qgis_default_value(), SINKROUTE = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("saga:sinkdrainageroutedetection")

  output <- qgisprocess::qgis_run_algorithm("saga:sinkdrainageroutedetection", `ELEVATION` = ELEVATION, `THRSHEIGHT` = THRSHEIGHT, `SINKROUTE` = SINKROUTE,...)

##' QGIS Algorithm provided by SAGA Simple kriging (saga:simplekriging)
##'
##' @title QGIS algorithm Simple kriging
##'
...
##' @param VAR_MODEL `string` - Model. String value.

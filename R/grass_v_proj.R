##' QGIS Algorithm provided by GRASS v.proj (grass:v.proj). Re-projects a vector layer to another coordinate reference system
##'
...
##' @param smax `number` - Maximum segment length in meters in output vector map. A numeric value. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression.
##' @param .z `boolean` - Assume z coordinate is ellipsoidal height and transform if possible. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -z.
##' @param .w `boolean` - Disable wrapping to -180,180 for latlon output. 1 for true/yes. 0 for false/no. field:FIELD_NAME to use a data defined value taken from the FIELD_NAME field. expression:SOME EXPRESSION to use a data defined value calculated using a custom QGIS expression. Original algorithm parameter name: -w.

##' QGIS Algorithm provided by GRASS v.delaunay (grass:v.delaunay). Creates a Delaunay triangulation from an input vector map containing points or centroids.
##'

##' QGIS Algorithm provided by GRASS i.his.rgb (grass7:i.his.rgb). Transforms raster maps from HIS (Hue-Intensity-Saturation) color space to RGB (Red-Green-Blue) color space.
##'

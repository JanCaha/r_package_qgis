...
saga_closegapswithspline <- function(GRID = qgisprocess::qgis_default_value(), MASK = qgisprocess::qgis_default_value(), MAXGAPCELLS = qgisprocess::qgis_default_value(), MAXPOINTS = qgisprocess::qgis_default_value(), LOCALPOINTS = qgisprocess::qgis_default_value(), NEIGHBOURS = qgisprocess::qgis_default_value(), RADIUS = qgisprocess::qgis_default_value(), RELAXATION = qgisprocess::qgis_default_value(), CLOSED = qgisprocess::qgis_default_value(),..., .complete_output = TRUE) {

  check_algorithm_necessities("saga:closegapswithspline")

  output <- qgisprocess::qgis_run_algorithm("saga:closegapswithspline", `GRID` = GRID, `MASK` = MASK, `MAXGAPCELLS` = MAXGAPCELLS, `MAXPOINTS` = MAXPOINTS, `LOCALPOINTS` = LOCALPOINTS, `NEIGHBOURS` = NEIGHBOURS, `RADIUS` = RADIUS, `RELAXATION` = RELAXATION, `CLOSED` = CLOSED,...)

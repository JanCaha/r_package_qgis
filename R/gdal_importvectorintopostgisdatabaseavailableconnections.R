...
##'
##' @title QGIS algorithm - Export to PostgreSQL (available connections)
##'
...
##' @param TABLE `databasetable` - Table to import to (leave blank to use layer name). Name of existing database table.

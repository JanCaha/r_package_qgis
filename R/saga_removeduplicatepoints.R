...
saga_removeduplicatepoints <- function(POINTS = qgisprocess:::qgis_default_value(), FIELD = qgisprocess:::qgis_default_value(), METHOD = qgisprocess:::qgis_default_value(), NUMERIC = qgisprocess:::qgis_default_value(), RESULT = qgisprocess:::qgis_default_value(),..., .complete_output = .complete_output_option(), .quiet = .quiet_option(), .messages = .message_option()) {

  check_algorithm_necessities("saga:removeduplicatepoints")

  if (.messages){
    output <- qgisprocess::qgis_run_algorithm("saga:removeduplicatepoints", `POINTS` = POINTS, `FIELD` = FIELD, `METHOD` = METHOD, `NUMERIC` = NUMERIC, `RESULT` = RESULT,..., .quiet = .quiet)
  } else {
    suppressMessages(
      output <- qgisprocess::qgis_run_algorithm("saga:removeduplicatepoints", `POINTS` = POINTS, `FIELD` = FIELD, `METHOD` = METHOD, `NUMERIC` = NUMERIC, `RESULT` = RESULT,..., .quiet = .quiet)
      )
